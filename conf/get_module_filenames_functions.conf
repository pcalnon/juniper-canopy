...
#
# Description:
#     This script Defines functions used by the get_module_filenames.sh script to create a list of all applicable python source files.
#
#####################################################################################################################################################################################################
# Notes:
#
...
function usage() {
    ...
    echo -ne "${USAGE}"
    [[ "${DEBUG}" == "${TRUE}" ]] && exit $(( RET_VAL )) || return $(( RET_VAL ))
}


#####################################################################################################################################################################################################
# Export Function Definition for the get_module_filenames.bash script
#####################################################################################################################################################################################################
export -f usage
