...
#####################################################################################################################################################################################################
if [[ "${GET_FILE_LINES_CONF_SOURCED}" != "${TRUE}" ]]; then
    export GET_FILE_LINES_CONF_SOURCED="${TRUE}"
else
    log_warning "get_file_lines.conf already sourced.  Skipping re-source."
...
export PROJ_ROOT_DIR_NAME="${SUB_PROJ_NAME}"
export PROJ_ROOT_DIR="${LANG_DIR}/${PROJ_ROOT_DIR_NAME}"
export PROJ_DIR_NAME="${APP_NAME}"
...
####################################################################################################
export ROOT_CONF_DIR_NAME="conf"
...
export UTIL_DIR="${BASE_DIR}/${UTIL_DIR_NAME}"
export TEST_DIR_NAME="tests"
export TEST_DIR="${BASE_DIR}/${TEST_DIR_NAME}"
export VIZ_DIR_NAME="viz"
export VIZ_DIR="${BASE_DIR}/${VIZ_DIR_NAME}"
