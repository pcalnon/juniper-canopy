...
if [[ "${GET_CODE_STATS_CONF_SOURCED}" != "${TRUE}" ]]; then
    export GET_CODE_STATS_CONF_SOURCED="${TRUE}"
else
...
# TODO: see if this can be removed since common.conf should define these
#####################################################################################################################################################################################################
