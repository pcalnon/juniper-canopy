...
- Refreshed developer and API documentation for the SEC-F22/SEC-F19 control-surface hardening: `docs/QUICK_START.md`, `docs/ENVIRONMENT_SETUP.md`, `docs/REFERENCE.md`, `docs/DEVELOPER_CHEATSHEET.md`, and `docs/api/API_REFERENCE.md` now document the fail-closed loopback bind guard, `JUNIPER_CANOPY_FRONTING_AUTH_ATTESTED`, canonical `JUNIPER_CANOPY_*` settings, and global/per-IP/per-session WebSocket caps.
