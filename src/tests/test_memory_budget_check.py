...
# canopy keeps tests in src/tests/ (pyproject: testpaths = ["src/tests"]),
# so the repo root is TWO levels up, not one. juniper-ml's copy of this file
# uses parents[1] because its tests live at the top level.
