...
class TestFetchNetworkStatsHandler:
    ...
    def test_fetch_network_stats_success(self, metrics_panel):
        ...
        with patch("requests.get") as mock_get:
            ...
            mock_get.assert_called_once_with("http://127.0.0.1:8050/api/network/stats", timeout=2, headers={})
...
class TestFetchTrainingStateHandler:
    ...
    def test_fetch_training_state_success(self, metrics_panel):
        ...
        with patch("requests.get") as mock_get:
            ...
            mock_get.assert_called_once_with("http://127.0.0.1:8050/api/state", timeout=2, headers={})
...
class TestTrainingProgressHandler:
    ...
    def test_training_progress_hides_when_max_values_zero(self, metrics_panel):
        """Zero max values should not attempt progress computation."""
        state = {
            "status": "RUNNING",
            "grow_iteration": 3,
            "grow_max": 0,
