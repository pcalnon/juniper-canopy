...
async def lifespan(app: FastAPI):
    ...
    # interface without either bind attestation (a loopback-only host publish or
    # a fronting authenticating proxy), instead of silently exposing the
    # in-network-bypassable browser training-control surface (audit HO-6).
    # Loopback binds (the default) start normally. Implemented inline in canopy
