...
| 2026-04-05 | Documentation Automation | Refreshed CI/dependency runbook references to match current lockfile automation behavior (`lockfile-check` + `lockfile-update`) and observability-extra lockfile generation command in `README.md`, `docs/ci_cd/CICD_MANUAL.md`, and `docs/ci_cd/CICD_REFERENCE.md`. |
