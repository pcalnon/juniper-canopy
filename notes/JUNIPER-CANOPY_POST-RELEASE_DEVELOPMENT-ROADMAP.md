...
| 2026-04-04 | Documentation Automation | Updated CI/CD and testing operational docs to match current pipeline contracts (`.github/workflows/ci.yml`) and optional test dependency gating (`pytest.importorskip` for `juniper-cascor-client[testing]` and `juniper-data-client[testing]`). Refreshed `docs/ci_cd/*` and `docs/testing/TESTING_ENVIRONMENT_SETUP.md` with lockfile/docs-link checks and marker-filter runbooks. |
