...
| 2026-04-04 | Documentation Automation | Refreshed CI/CD docs to align with current workflow behavior in `.github/workflows/ci.yml` and `.github/workflows/lockfile-update.yml` (Python 3.12/3.13/3.14 matrix, lockfile `--extra observability`, docs-link validation runbook, and local reproduction commands). Updated `README.md` lockfile command and observability extra notes accordingly. |
