...
- The main repo directory is accessible at `/home/pcalnon/Development/python/Juniper/juniper-canopy`
...
# Main repo
MAIN_REPO="/home/pcalnon/Development/python/Juniper/juniper-canopy"
```
...
gh pr create --repo pcalnon/juniper-canopy --base main --head "$OLD_BRANCH" \
...
Run the cleanup procedure for each worktree individually.
...
The V1 file has been moved to `notes/history/WORKTREE_CLEANUP_PROCEDURE_V1.md`.
